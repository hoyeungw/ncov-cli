...
import { iso, range } from '@vect/vector-init';
...
const regionsStat = async dataTable => {
  ...
  const table = (_tableJoin2 = tableJoin(dataTable, refTable, [ID], LEFT), Table.from(_tableJoin2));
  let t = chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.count));
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.cases)), [REGION], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.deaths)), [REGION], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.population)), [REGION], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.casesInMillion)), [REGION], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.deathsInMillion)), [REGION], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.regionSet, {}, Formulas.deathRate)), [REGION], LEFT);
...
const incomeLevelsStat = async dataTable => {
  ...
  // const dataTable = await Ncov.global({ top: 0 })
  const table = (_tableJoin3 = tableJoin(dataTable, refTable, [ID], LEFT), Table.from(_tableJoin3));
  let t = chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.count));
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.cases)), [INCOMELEVEL], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.deaths)), [INCOMELEVEL], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.population)), [INCOMELEVEL], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.casesInMillion)), [INCOMELEVEL], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.deathsInMillion)), [INCOMELEVEL], LEFT);
  t = tableJoin(t, chipStat(table, _objectSpread2({}, Fields.incomeLevelSet, {}, Formulas.deathRate)), [INCOMELEVEL], LEFT);
  return Table.from(t).sort(CASES, NUM_DESC);
};

const chipStat = (table, {
  side,
  field,
  filter,
  formula,
  ...
  if (sideFields) mutate(crostab.side, x => {
    var _sideFields$x;
...
class NcovCli {
  static async start() {
    ...
    if (scope === STAT) {
      ...
      _ref2 = '', logger(_ref2);
      _ref3 = (_await$regionsStat = await regionsStat(table), decoTable(_await$regionsStat)), says[REGION](_ref3);
      _ref4 = '', logger(_ref4);
      _ref5 = (_await$incomeLevelsSt = await incomeLevelsStat(table), decoTable(_await$incomeLevelsSt)), says[INCOMELEVEL](_ref5);
      _ref6 = '', logger(_ref6);
      return void 0;
    }
    ...
    await Ncov[scope]({
      ...
      spn.succeed(Xr('updated')['scope'](scope)['timestamp'](now()).toString());
      if (format === TABLE) _ref7 = (_result = result, DecoTable({
        read: x => typeof x === NUM ? mag.format(x) : decoFlat(x)
      })(_result)), says['corona latest report'].br(scope)(_ref7);
      if (format === SAMPLES) _ref8 = (_result2 = result, decoSamples(_result2)), says['corona latest report'](_ref8);
    });
    _ref9 = '', logger(_ref9);
  }
