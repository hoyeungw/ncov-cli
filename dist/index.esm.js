        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref$format = _ref.format, format = _ref$format === void 0 ? TABLE : _ref$format, _ref$sortBy = _ref.sortBy, sortBy = _ref$sortBy === void 0 ? 'cases' : _ref$sortBy, _ref$top = _ref.top, top = _ref$top === void 0 ? 15 : _ref$top, fields = _ref.fields;
                _context.next = 3;
                return Acq.tabular({
                  title: 'ncov',
                  ...
                  prep: function prep(samples) {
                    ...
                    if (fields) table.select(fields, MUTABLE);
                    if (sortBy && table.head.includes(sortBy)) table.sort(sortBy, NUM_DESC, MUTABLE);
...
var LIST = 'list',
    ...
    TODAY = 'today',
    RATIO = 'ratio';
var RANGE200 = range(1, 200);
var COLORED_RANGE200 = fluoVector(RANGE200);
var mag = new Mag(0);
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return inquirer.prompt([{
                  ...
                  choices: zipper(COLORED_RANGE200, RANGE200, function (name, value) {
                    return {
                      name: name,
                      value: value
                    };
