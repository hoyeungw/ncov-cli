...
var Ncov = /*#__PURE__*/function () {
  function Ncov() {
    _classCallCheck(this, Ncov);
  }

  _createClass(Ncov, null, [{
    key: "latest",
    value: function () {
      var _latest = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
        var _ref,
            _ref$format,
            format,
            _ref$sortBy,
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref$format = _ref.format, format = _ref$format === void 0 ? enumTabularTypes.TABLE : _ref$format, _ref$sortBy = _ref.sortBy, sortBy = _ref$sortBy === void 0 ? 'cases' : _ref$sortBy, _ref$top = _ref.top, top = _ref$top === void 0 ? 15 : _ref$top, fields = _ref.fields;
                _context.next = 3;
                return acq.Acq.tabular({
                  title: 'ncov',
...
var LIST = 'list',
    ...
    TODAY = 'today',
    RATIO = 'ratio';
var RANGE200 = vectorInit.range(1, 200);
var COLORED_RANGE200 = fluoVector.fluoVector(RANGE200);
var mag = new mag$1.Mag(0);
var NcovCli = /*#__PURE__*/function () {
  function NcovCli() {
    _classCallCheck(this, NcovCli);
  }

  _createClass(NcovCli, null, [{
    key: "start",
    value: function () {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return inquirer.prompt([{
                  ...
                  choices: vectorZipper.zipper(COLORED_RANGE200, RANGE200, function (name, value) {
                    return {
                      name: name,
                      value: value
                    };
                  ...
                  filter: function filter(answers) {
                    return objectInit.iso(answers, true);
                  }
                }]);
              ...
              case 3:
                ...
                makeFields = function makeFields() {
                  ...
                  if (ratio) mergeAcquire.acquire(fields, RATIO_FIELDS);
                  return fields;
                };
